...
<div class="col-xs-12 col-sm-12">
        ...
        <div class="rest-container">
            ...
            <div class="address-title">Report Driver</div>

            <!--Information Container Start-->
            <div class="border-bottom-primary">
                <div class="support-description-text font-weight-light">
                    Please provide a detailed description of any issues you have encountered with our delivery rider. Our team is ready to assist you promptly.
                </div>
            </div>
