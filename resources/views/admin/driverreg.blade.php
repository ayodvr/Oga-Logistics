                            ...
                            <div class="col-md-12 m-b-30">
                                ...
                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                    <div class="page-title mb-2 mb-sm-0">
                                        <h1>Create New Driver Account</h1>
                                    </div>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page">Driver</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                       ...
                       <div class="row formavlidation-wrapper">
                            <div class="col-xl-12">
                                <div class="card card-statistics">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" class="form-horizontal" action="{{ route('storeDriver') }}">
                                          @csrf
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="username1">NIN</label>
                                                <div class="mb-2">
                                                    <input type="text" class="form-control" id="nin" name="nin" placeholder="National Identification Number" />
                                                </div>
                                            </div>
                                            <div class="form-group">
