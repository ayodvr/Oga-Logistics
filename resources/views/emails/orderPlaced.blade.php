            	...
            	<tr>
            		<td>
            			...
            			<div class="text" style="padding: 0 2.5em;color: black; ">
                            ...
                            <p>A new order has been placed, See order details below.</p>
            			</div>
                        @endrole
                        @role('customer')
                        <div class="text" style="padding: 0 2.5em;color: black; ">
            				<p>Dear {{$user_name}},</p>
                            <p>Thank you for using Ogaglobal Logistics, your order was received, kindly see below for order details.</p>
            			</div>
                        @endrole
            		</td>
            	</tr>
